...
@Service//这个service 写spring不写alibaba的也可以  因为目前是在一个项目中。
...
//        PaymentInfo paymentInfoHas = paymentInfoMapper.selectOne(paymentInfo);
//        paymentInfoMapper.updateByPrimaryKey(paymentInfoHas);
    }
...
//        String outTradeNo = JSON.toJSONString(map);
