...
public class PaymentController {
    ...
    public String submitPayment(HttpServletRequest request, HttpServletResponse response){
        ...
        paymentInfo.setSubject("购买宇宙飞船带大家去旅游。");
    ...
    public String callbackReturn(){
        return "redirect://"+AlipayConfig.return_order_url;//地址不行这了也可以写死啊
    }
    ...
    public String paymentNotify(@RequestParam Map<String,String> paramMap, HttpServletRequest request) throws AlipayApiException {
        ...
        // 在得知成功的情况下，更新订单的状态： 前提：交易状态TRADE_SUCCESS，TRADE_FINISHED
