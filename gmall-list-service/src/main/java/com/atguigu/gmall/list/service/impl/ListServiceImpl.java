...
public class ListServiceImpl implements ListService {
    ...
    public void saveSkuInfo(SkuLsInfo skuLsInfo) {
        ...
        // 如何向es中添加数据。 查询Search.Bulid(query);
        // PUT /gmall/SkuInfo/1
    ...
    public SkuLsResult search(SkuLsParams skuLsParams) {
        ...
        try {
            // 执行的结果： searchResult -- 变化成我们封装好的结果集对象 这个查出来是错的result啊
    ...
    @Override
    public void incrHotHcore(String skuId) {
        //获取redis
    ...
    // 执行的结果： searchResult -- 变化成我们封装好的结果集对象  这里传过来的searchResult错了
