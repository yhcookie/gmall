...
import com.atguigu.gmall.OrderDetail;
...
public class OrderServiceImpl implements OrderService{
    ...
    public String saveOrder(OrderInfo orderInfo) {
        //在要写这里的时候 去看了OrderInfo表里的列们 知道了还有要写好多数据到OrderInfo对象里
        //订单的创建时间
    ...
    public boolean checkStock(String skuId, Integer skuNum) {
        ...
        String result =
                HttpClientUtil.doGet("http://www.gware.com/hasStock?skuId=" + skuId + "&num=" + skuNum);
        if ("1".equals(result)){
            return  true;
        }else {
            return false;
